...
const ShowVideoGrid = ({ videos, isToggleSidebar, List }) => {
  return (
    <>
      ...
      <div
        className="flex flex-wrap p-5 relative videos-container gap-6 -top-[750px] lg:w-[100vw] md:w-[900px] sm:w-[600px] mbsm:w-[300px] lg:left-[250px] md:left-[250px] sm:left-[200px] left-[60px] xsm:w-[450px] w-[600px] lg:-top-[400px]"
